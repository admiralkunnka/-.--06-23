...
Это экран "Начало". На нем есть кнопка начать для перехода на экран всех заметок.
...
Безусловно, переход по экранам крайне удобен и понятен. Думаю, над дизайном еще надо поработать.
